...
use Sak\Core\SearchParser\Exceptions\InvalidMiddlewareException;
...
abstract class AbstractResolver
{
    ...
    protected function middlewaresFrame()
    {
        return function ($prevCarry, $middleware) {
            return function (Builder $builder, CaseInterface $caseInstance) use ($prevCarry, $middleware) {
    ...
    public static function checkIsExpAvailable($exp)
    {
